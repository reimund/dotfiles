...
hi FoldColumn	guifg=darkgray			guibg=lightgray		gui=none
hi FoldColumn	ctermfg=darkgray		ctermbg=lightgray	cterm=none
...
hi LineNr		guifg=darkgray			guibg=white			gui=none
hi LineNr		ctermfg=darkgray		ctermbg=white		cterm=none
